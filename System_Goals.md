...
[ ] Aesthetic Alignment: Weight all recommendations based on the active Sector Theme (e.g., prioritizing high-contrast in "VOLTAGE" mode).
...
[ ] Scent_Sync (Fragrance Mapping): Map fragrance library to outfit "Vibe Scores" (e.g., Fresh/Citrus for "Voltage," Woody/Deep for "Parchment").
...
[ ] Cost_Per_Wear: Divide garment price by wear-count to calculate real-world value vs. "Vault Rot."

8. System_Hardening // Dev-Ops
...
9. Business_Pivot // Commercial Viability
